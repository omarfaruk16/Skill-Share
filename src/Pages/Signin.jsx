...
const Signin = () => {
  ...
  const { SignInEmailPass, SignInwithGoogle, PasswordReset } =
    useContext(AuthContext);
  const [error, setError] = useState("");
  const [pastemail, setPastmail] = useState("");
            ...
            <form className="w-full space-y-5" onSubmit={HangleSignIn}>
              ...
              <div className="space-y-2">
                ...
                <input
                  ...
                  name="email"
                  ref={emailRef}
                  onChange={(e) => setPastmail(e.target.value)}
            ...
            <div className="space-y-2">
              <label className="block text-xl text-center font-bold text-gray-800 ml-1">
                ...
                <span className="text-sm font-light">
                  Enter your valid email. You will get an email. From here you
              ...
              <input
                type="email"
                name="email"
                placeholder={pastemail|| "you@example.com"}
                className="w-full px-4 py-3.5 rounded-xl border border-gray-200 bg-gray-50/50 focus:outline-none focus:ring-2 focus:ring-yellow-400 focus:border-transparent transition-all placeholder:text-gray-400"
              />
            </div>
            <button
